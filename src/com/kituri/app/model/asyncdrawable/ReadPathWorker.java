...
public class ReadPathWorker extends MyAsyncTask<String, Integer, Bitmap> implements IPictureWorker {
    ...
    public ReadPathWorker(ImageView view, String path, FileLocationMethod method, boolean isMultiPictures) {
    ...
    public ReadPathWorker(ImageView view, String url, FileLocationMethod method) {
        this(view, url, method, false);
    }

    public ReadPathWorker(IWeiciyuanDrawable view, String url, FileLocationMethod method, boolean isMultiPictures) {
...
//        }
    ...
    public ReadPathWorker(IWeiciyuanDrawable view, String url, FileLocationMethod method) {
        this(view, url, method, false);
    }
    ...
    protected Bitmap doInBackground(String... url) {
        ...
        switch (method) {
            ...
            case avatar_large:
            	try {
            		bitmap = ImageUtility.readNormalPic(data, width, height);
