...
public class ReadWorker extends MyAsyncTask<String, Integer, Bitmap> implements IPictureWorker {
    ...
    private DownLoadBitmapListener mDownLoadBitmapListener;
    ...
    public ReadWorker(ImageView view, String url, FileLocationMethod method, boolean isMultiPictures) {
    	this(view, url, method, isMultiPictures, null);
    }
    ...
    public ReadWorker(ImageView view, String url, FileLocationMethod method, boolean isMultiPictures,
        ...
        this.mDownLoadBitmapListener = downLoadBitmapListener;
    }
        ...
        switch (method) {
            ...
            case picture_large:
                if (!isMultiPictures) {
                    ...
                    //8 is layout padding
                    //2 is size limit
                    width = (int) (metrics.widthPixels - (8 + 8) * reSize) / 2;
                } else {
        ...
        if (imageView != null) {
            if (canDisplay(imageView)) {
                ...
                if (bitmap != null) {
                    ...
                    if(mDownLoadBitmapListener != null){
                    	mDownLoadBitmapListener.onDownLoadCompleted(data, bitmap);
                    }
                    ...
                    if(mDownLoadBitmapListener != null){
                    	mDownLoadBitmapListener.onDownLoadFailed(data, bitmap);
                    }
                }
