...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    public ImagePagerAdapter(Activity activity, ListEntry datas,
...
//    if(data instanceof DynamicMovieData){
////    	DynamicMovieData movie = (DynamicMovieData)mDatas.getEntries().get(position);   
//
//    	 llCommenScan.setVisibility(View.VISIBLE);
//    	 movieView.setVisibility(View.VISIBLE);
//    	 movieIv.setVisibility(View.VISIBLE);	
//    	 DynamicMovieData movieData = (DynamicMovieData) data;
//    	 mCommentNum.setText(String.valueOf(movieData.getReplies()));
//    	 mScanNum.setText(String.valueOf(movieData.getClicks()));
//    	 movieView.setOnClickListener(new OnClickListener() {
//			
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				//KituriApplication.getInstance().gotoMovie(mDatas.getEntries().get(position));
//				if(mSelectionListener != null){
//					data.setIntent(new Intent(Intent.ACTION_GOTO_MOVIE));
//					mSelectionListener.onSelectionChanged(data, true);
//				}
//			}
//		});
//    } else if(data instanceof DynamicPicData){
//    	llCommenScan.setVisibility(View.VISIBLE);
//    	DynamicPicData picData = (DynamicPicData) data;   	 
//    	mCommentNum.setText(String.valueOf(picData.getReplies()));
//    	mScanNum.setText(String.valueOf(picData.getClicks()));
...
//    }
    ...
    if(!TextUtils.isEmpty(photoable.getLocalPath())){
    	path = photoable.getLocalPath();
    }else{
    	path = FileManager
                .getFilePathFromUrl(photoable.getPhotoUrl(), FileLocationMethod.picture_large);

    }
    
    boolean shouldDownLoadPicture = !fromInstantiateItem || (fromInstantiateItem && Utility
            .isWifi(contentView.getContext()));
