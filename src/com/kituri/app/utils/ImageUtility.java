...
public class ImageUtility {
    ...
    public static Bitmap getRoundedCornerPic(String url, int reqWidth, int reqHeight, FileLocationMethod method, FileDownloaderHttpHelper.DownloadListener downloadListener){
        try {
            ...
            if (!filePath.endsWith(".jpg") && !filePath.endsWith(".gif") && !filePath.endsWith(".jpeg") && !filePath.endsWith(".png"))
...
//    public static Bitmap getResCornerPic(int resId) {
//    	return getResCornerPic(resId, reqWidth, reqHeight, 0);
//    }
    
    public static Bitmap getResCornerPic(int resId, int reqWidth, int reqHeight) {
    	return getResCornerPic(resId, reqWidth, reqHeight, 0);
    }
    
    public static Bitmap getResCornerPic(int resId, int reqWidth, int reqHeight, int cornerRadius) {
        try {
...
//            }
            ...
            BitmapFactory.Options options = new BitmapFactory.Options();
            options.inJustDecodeBounds = true;
            BitmapFactory.decodeResource(KituriApplication.getApplication().getResources()
            		,resId, options);
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(KituriApplication.getApplication().getResources()
            		,resId, options);
    ...
    public static Bitmap getMiddlePictureInBrowserMSGActivity(String url, FileLocationMethod method, FileDownloaderHttpHelper.DownloadListener downloadListener) {
        ...
        try {
            ...
            if (file.exists()) {
                DisplayMetrics displayMetrics = KituriApplication.getInstance().getDisplayMetrics();
    ...
    public static String compressPic(Context context, String picPath) {
        ...
        switch (UPLOAD_QUALITY/*SettingUtility.getUploadQuality()*/) {
            case 1:
                return picPath;
            case 2:
