package com.kituri.net.http.error;
 ...
 * 
 */
public class KituriException extends Exception {
    ...
    public String getError() {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            int i = KituriApplication.getInstance().getResources()
                    .getIdentifier(name, "string", KituriApplication.getInstance().getPackageName());

            try {
                result = KituriApplication.getInstance().getString(i);
                ...
                if (!TextUtils.isEmpty(oriError)) {
                    ...
                    result = KituriApplication.getInstance().getString(R.string.unknown_error_error_code) + error_code;
                }
            }
        }
    ...
    public KituriException() {

    }

    public KituriException(String detailMessage) {
        error = detailMessage;
    }

    public KituriException(String detailMessage, Throwable throwable) {
        error = detailMessage;
    }
