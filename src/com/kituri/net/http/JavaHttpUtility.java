...
import com.kituri.net.http.error.ErrorCode;
...
//            }
    ...
    private String handleError(HttpURLConnection urlConnection) throws KituriException {
        ...
        try {
            ...
            KituriException exception = new KituriException();
    ...
    private String readError(HttpURLConnection urlConnection) throws KituriException {
        InputStream is = null;
        BufferedReader buffer = null;
        KituriApplication globalContext = KituriApplication.getInstance();
        String errorStr = globalContext.getString(R.string.timeout);
        ...
        try {
            ...
            if (is == null) {
                errorStr = globalContext.getString(R.string.network_error);
                throw new KituriException(errorStr);
            }
    ...
    public boolean doUploadFile(String urlStr, Map<String, String> param, String path, String imageParamName, final FileUploaderHttpHelper.ProgressListener listener) throws KituriException {
        ...
        try {
            ...
            if (status != HttpURLConnection.HTTP_OK) {
                ...
                throw new KituriException(error);
            }
